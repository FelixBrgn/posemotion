...
test('DetectionAngle', () => {
  expect(detectionAnglePosenet.next(posenetOutputClose)).toStrictEqual(['mid', 'open']);
  expect(detectionAnglePosenet.next(posenetOutputOpen)).toStrictEqual(['close', 'open']);
});
